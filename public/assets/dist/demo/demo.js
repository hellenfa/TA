(function(root, factory) {
  ...
  // var DIST_PATH = locationParts[locationParts.length - 2] === 'docs' ? '..' : '../../assets';
  var DIST_PATH = document.location.origin+'/piu_project/public/assets';
  var pxDemo = (function() {
    ...
    var BACKGROUNDS = [
      ...
      // DIST_PATH + '/dist/demo/bgs/3.jpg',
        DIST_PATH + '/images/background.jpg',
    ...
    function initializeDemoSidebar() {
      ...
      content += '<h6 class="px-demo-sidebar-header bg-primary darker b-y-1">TEMA</h6>';
